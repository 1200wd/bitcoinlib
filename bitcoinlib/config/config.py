...
def read_config():
    ...
    if not default_databasefile.startswith('postgresql') and not default_databasefile.startswith('mysql'):
    ...
    if not default_databasefile_cache.startswith('postgresql') and not default_databasefile_cache.startswith('mysql'):
