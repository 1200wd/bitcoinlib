...
from bitcoinlib.networks import Network, NETWORK_DEFINITIONS, DEFAULT_NETWORK, network_by_value, network_values_for
...
class Key:
    ...
    def private_byte(self):
        if not self.secret:
            return False
        return change_base(str(self.secret), 10, 256, 32)
