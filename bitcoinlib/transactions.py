...
class Transaction:
    ...
    def import_raw(rawtx):
        ...
        for i in range(0, n_inputs):
            ...
            inp_index = rawtx[cursor+32:cursor+6][::-1]
            cursor += 36
            ...
            inputs.append({
                ...
                'output_index': change_base(inp_index, 256, 16),
        ...
        return Transaction(inputs, outputs, locktime, version, sequence_number)

    def __init__(self, inputs, outputs, locktime=0, version=b'00000001', sequence_number=b'ffffffff'):
        self.inputs = inputs
        self.outputs = outputs
        self.version = version
        self.locktime = locktime
        self.sequency_number = sequence_number
...
if __name__ == '__main__':
    ...
    # Large number of inputs, for the rest nonsense tx
    rli = ''
    ...
    r = '01000000' \
        ...
        '6a' \
        '47' \
        '304402201f6e18f4532e14f328bc820cb78c53c57c91b1da9949fecb8cf42318b791fb38022045e78c9e55df1cf3db74bfd52ff2add2b59ba63e068680f0023e6a80ac9f51f4' \
        '01' \
        '21' \
        '0239a18d586c34e51238a7c9a27a342abfb35e3e4aa5ac6559889db1dab2816e9d' \
        'feffffff' \
        '02' \
        '3ef5980400000000' \
        '19' \
        '76' \
        'a9' \
        '14af8e14a2cecd715c363b3a72b55b59a31e2acac9' \
        '88' \
        'ac' \
        '90940d0000000000' \
        '19' \
        '76' \
        'a9' \
        '14f0d34949650af161e7cb3f0325a1a88330751650' \
        '88' \
        'ac' \
        'b7740f00'

    t = Transaction.import_raw(r3)
    pprint(t.get())
